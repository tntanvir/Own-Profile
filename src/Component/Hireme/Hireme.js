        ...
        <section id='hireme' className="py-10 px-3 text-white">
            ...
            <div className='bg-gray-700 relative px-8 rounded-2xl py-5 lg:max-w-4xl mx-auto min-h-[24rem] mt-24 flex gap-6 lg:flex-row flex-col-reverse items-center'>
                <div>
                    ...
                    <p className='max-w-lg text-sm mt-4 text-gray-200 text-justify leading-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur rerum laudantium non! Accusamus ratione facilis tempore molestias ipsum temporibus culpa iusto blanditiis dolorem. Maiores quibusdam fuga tenetur dolore explicabo beatae?</p>
