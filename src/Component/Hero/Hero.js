...
import hero from '../../imges/IMG_0408_032931 (1).jpg'
    ...
    return (
        <section id='home' className='min-h-screen flex py-10 md:flex-row flex-col items-center'>
            <div className='flex-1 flex justify-center items-center'>
                <div className='md:w-80 h-full relative sm:w-10/12 w-11/12 max-w-sm'>
                    <img src={hero} alt="" className='rounded-full md:rounded-none' />
                </div>
            </div>
            <div className="flex-1">
                <div className='md:text-left text-center'>
                    <h1 className='md:text-5xl text-2xl md:leading-normal leading-10 text-white font-bold'>
                        <span className='text-cyan-500 md:text-6xl text-5xl'>
                            Hello!
                            <br />
                        </span>
                        I'm <span>Tanvir</span>
                    </h1>
